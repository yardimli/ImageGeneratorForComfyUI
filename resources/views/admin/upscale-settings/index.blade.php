	...
	<div class="container py-4">
		<div class="card">
			...
			<div class="card-body">
				...
				@if($models->isEmpty())
					<div class="alert alert-warning">No upscale models found. Please run the seeder.</div>
				@else
										...
										@foreach($model->input_schema as $field)
											<div class="col-md-6 mb-3">
												...
												@elseif($field['type'] === 'boolean')
													<select name="settings[{{ $field['name'] }}]" class="form-select">
														<option value="1" {{ $value === true || $value === 1 || $value === '1' ? 'selected' : '' }}>True</option>
														<option value="0" {{ $value === false || $value === 0 || $value === '0' ? 'selected' : '' }}>False</option>
													</select>
