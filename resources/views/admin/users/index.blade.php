    ...
    <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <div class="overflow-x-auto">
            <table class="w-full min-w-[920px] text-left text-sm">
                <thead class="bg-slate-50 text-xs uppercase tracking-wider text-slate-500 dark:bg-slate-800/70 dark:text-slate-400"><tr><th class="px-5 py-4">User</th><th class="px-4 py-4">Role</th><th class="px-4 py-4 text-right">Prompts</th><th class="px-4 py-4 text-right">Images</th><th class="px-4 py-4 text-right">Covers</th><th class="px-4 py-4 text-right">Stories</th><th class="px-4 py-4 text-right">Dictionary</th><th class="px-5 py-4">Last generation</th><th class="px-5 py-4"></th></tr></thead>
