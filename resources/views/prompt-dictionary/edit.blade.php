						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="image-upload-container mb-2 position-relative" style="min-height: 150px; border: 2px dashed #ccc; padding: 10px; text-align: center;">
									<img src="{{ $entry->image_path ? \App\Support\ImageUrl::preview($entry->image_path) : 'https://via.placeholder.com/200' }}"
								     ...
								     data-image-url="{{ \App\Support\ImageUrl::preview($entry->image_path) }}"
			...
			<div class="fixed-save-bar">
				<div class="container">
					...
					<div class="d-flex justify-content-end align-items-center">
						@if($entry->exists)
							<button type="button" class="btn btn-danger me-3" data-ui-toggle="modal" data-ui-target="#deleteEntryModal">
