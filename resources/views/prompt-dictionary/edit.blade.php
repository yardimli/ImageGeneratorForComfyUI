						...
						<div class="row">
							<div class="col-md-8">
								...
								<div class="mb-3">
									...
									<textarea name="image_prompt" class="form-control image-prompt-textarea" rows="3" data-initial-value="{{ e($entry->image_prompt ?? '') }}">{{ old('image_prompt', $entry->image_prompt) }}</textarea>
