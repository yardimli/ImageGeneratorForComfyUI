							...
							<div class="row">
								<div class="col-md-8">
									...
									<div class="mb-3">
										...
										<button type="button" class="btn btn-sm btn-outline-success mt-2 draw-with-ai-btn" data-asset-id="{{ $character->id ?? '' }}">
								...
								<div class="col-md-4">
									...
									<div class="image-upload-container mb-2 position-relative" style="min-height: 150px; border: 2px dashed #ccc; padding: 10px; text-align: center;">
										<img src="{{ $character->image_path ?: 'https://via.placeholder.com/200' }}"
