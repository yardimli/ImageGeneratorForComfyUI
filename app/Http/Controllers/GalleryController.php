...
class GalleryController extends Controller
{
	public function index(Request $request)
	{
		...
		if (!empty($search)) {
			$selectedTypes = ['mix', 'mix-one', 'schnell', 'dev', 'minimax', 'minimax-expand', 'imagen3', 'aura-flow','ideogram-v2a','luma-photon','recraft-20b', 'fal-ai/qwen-image'];
		} else {
			$selectedTypes = $request->query('types', ['mix', 'mix-one', 'schnell', 'dev', 'minimax', 'minimax-expand', 'imagen3', 'aura-flow','ideogram-v2a','luma-photon','recraft-20b', 'fal-ai/qwen-image']);
